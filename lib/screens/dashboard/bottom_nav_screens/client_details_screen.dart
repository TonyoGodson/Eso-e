...
class _ClientDetailsScreenState extends State<ClientDetailsScreen> {
  ...
  Future toggleVisibility() async {
    ...
    Navigator.of(context).pushNamed(ClientRecentInteractionsScreen.routeName);
  ...
  //   setState(() {
  //     isVisible = true;
  //     RecentInteractionsScreen(CDSVisibility: toggleVisibility2);
  //     debugPrint("CDSVisibility method");
  //   });
  ...
  Widget build(BuildContext context) {
    final clientDetail = ModalRoute.of(context)?.settings.arguments as ClientListModel;
    return
      // WillPopScope(
      // onWillPop: () async {
            ...
            AnimatedOpacity(
              ...
              child: Container(
                  ...
                  children: [
                   Column(
                      children: [
                        ...
                        CircleAvatar(
                          radius: 25,
                          backgroundImage: AssetImage("${clientDetail.pic}"),
                        ),
                        ...
                        Text("${clientDetail.acct_type}".toUpperCase(),
                          style: const TextStyle(
                            fontSize: 10.0,
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: clientDetail.status != 0
                                ? const Color(0xFFDFF6DD)
                                : const Color(0xFFE1DFDD)),
                            child: clientDetail.status != 0
                              ? const Text("Active",
                                  style: TextStyle(
                ...
                Column(
                  ...
                  children: [
                  Text("${clientDetail.customer_type}",
                      style: const TextStyle(
                          fontSize: 13.0,
                          fontWeight: FontWeight.w500,
                          color: Colors.black)),
                  ...
                  Text("${clientDetail.activatn_date}",
                    style: const TextStyle(
                        fontSize: 13.0,
                        fontWeight: FontWeight.w500,
                        color: Colors.black)),
                  ...
                  const Text("ACTIVATION DATE",
                          ...
                          color: Colors.black54)),
                  const SizedBox(height: 20),
                  Text("${clientDetail.acct_officer}",
                      style: const TextStyle(
                          fontSize: 13.0,
                          fontWeight: FontWeight.w500,
                          color: Colors.black)),
