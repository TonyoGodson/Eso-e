...
class LeadRecentInteractionsTab extends StatefulWidget {
  const LeadRecentInteractionsTab({Key? key}) : super(key: key);

  @override
  State<LeadRecentInteractionsTab> createState() => _LeadRecentInteractionsTabState();
}

class _LeadRecentInteractionsTabState extends State<LeadRecentInteractionsTab> with SingleTickerProviderStateMixin {
