...
import 'client_new_interaction_screen.dart';

class ClientRecentInteractionsScreen extends StatefulWidget {
  static const routeName = '/client_recent_interactions_screen';
  final VoidCallback CDSVisibility;
  const ClientRecentInteractionsScreen({Key? key, required this.CDSVisibility}) : super(key: key);

  @override
  State<ClientRecentInteractionsScreen> createState() => _ClientRecentInteractionsScreenState();
}

class _ClientRecentInteractionsScreenState extends State<ClientRecentInteractionsScreen> {
  int buttonNo = 0;
  bool isVisible = true;
  double bkBtnHt = 50.0;
  double bkBtnWt = 50.0;
        ...
        children: [
          Align(
            ...
            child: GestureDetector(
              onTap: (){
                Navigator.of(context).pushNamed(ClientNewInteractionScreen.routeName);
              },
              child: Container(
