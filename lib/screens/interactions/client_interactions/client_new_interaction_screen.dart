...
import 'client_interaction_created.dart';



class ClientNewInteractionScreen extends StatefulWidget {
  static const routeName = 'client_new_interactions_screen';
  const ClientNewInteractionScreen({Key? key}) : super(key: key);

  @override
  State<ClientNewInteractionScreen> createState() => _ClientNewInteractionScreenState();
}

class _ClientNewInteractionScreenState extends State<ClientNewInteractionScreen> {
                  ...
                  child: Container(
                      ...
                      child: Padding(
                          ...
                          child: SvgPicture.asset(
                              "asset/svg_icons/delete_icon.svg",
                              color: Colors.red))),
                ),
  ...
  void _handleFormSubmit(BuildContext context) async {
    Navigator.of(context).pushNamed(ClientInteractionCreatedScreen.routeName);
    Future.delayed(const Duration(seconds: 2), () {
      Navigator.pop(context);
    });
  }

  _showPopUpContainer(BuildContext context) {
    showDialog(
        context: context,
